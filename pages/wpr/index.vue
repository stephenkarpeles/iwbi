      ...
      <div class="py-2 align-middle w-full sm:px-6 lg:px-8">
                ...
                <template #content>
                  <div class="w-full md:w-56">
                    <WButtonsBase
                      ...
                      @click.native="$router.push('/wpr/create/landing')"
                    >
                      Enroll Now
                    </WButtonsBase>
                    <!-- <WButtonsBase
                      type="blank"
                      class="px-4 flex focus:outline-none py-3 text-primary-700 w-full"
                      @click.native="$router.push('/wpr/roadmap')"
                    >
                      Plan Your Journey
                    </WButtonsBase>
                    <WButtonsBase
                      type="blank"
                      class="px-4 flex focus:outline-none py-3 text-primary-700 w-full"
                      @click.native="$router.push('/wpr/estimator/create')"
                    >
        ...
        <WFeedbackModal ref="modal">
          <div class="max-w-lg mx-2 my-2 md:mx-10 md:my-5">
            ...
            <div class="mb-5 text-primary-800 py-4">
              This will remove
            ...
            <table class="w-full divide-y divide-gray-200">
              <thead>
                <tr class="text-white bg-primary-700">
                  ...
                  <th
                    class="px-3 md:px-6 py-3 text-xs leading-4 font-medium uppercase text-left tracking-wider"
                  >
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                >
                  ...
                  <td
                    class="px-3 md:px-6 py-4 whitespace-nowrap text-sm leading-5 font-medium"
                  >
                  ...
                  >
                    <Popover
                      ...
                      :ref="`actions-${index}`"
                      class="white-gradient h-full md:inline-flex rounded-md sm:mt-0 w-full justify-center z-30"
                      extra-classes="mr-16"
                            ...
                            @click.native="
                              $router.push(
                                sharedWorkspace.assessment.completed_at
                                  ? `/wpr/roadmap/report/${sharedWorkspace.assessment.code}`
                                  : `/wpr/roadmap/${sharedWorkspace.assessment.code}`
                              )
                            "
                          >
                            <span
