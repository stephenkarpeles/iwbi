<template>
  <div>
    <div v-if="currentUser" class="">
      ...
      <NavBreadcrumbs>
        <WHeadingsHTwo class="mb-2" heading="WELL v2 Pilot Project Creation" />
        <WStepsHorizontal
          :steps="[
            {
      ...
      <WLinksBase
        ...
        @click.native="$router.push('/projects/v2-pilot/')"
      >
        Back to list
      </WLinksBase>

      <div class="relative mt-3 bg-white rounded-lg shadow-md">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <WButtonsBase @click.native="currentStep++">
                          Select
                        </WButtonsBase>
                      </div>
                    </div>
          ...
          <div class="lg:pr-8" style="min-height: 460px">
            ...
            >
              ...
              <FormulateForm @submit="validateStep">
                ...
                />
                <FormulateInput class="mt-24" type="submit" label="Continue" />
              </FormulateForm>
            </div>
            <div
            ...
            >
              ...
              <FormulateForm @submit="validateStep">
                ...
                <div class="w-full relative">
                  ...
                  />
                  <div
                    class="absolute right-0 top-0 flex h-full bg-primary-100 text-primary-400 border border-primary-300 rounded-r"
                  >
...
export default {
  ...
  methods: {
    ...
    head() {
      return {
        title: `Create a v2 Pilot Certification`,
      }
    },
  },
}
