    ...
    <FormulateForm v-if="portfolio && portfolio.id" @submit="nextStep">
      <div class="flex justify-between my-2 text-gray-500 items-center">
        <WHeadingsHThree
          ...
          heading="Portfolio Locations Import"
        />
      ...
      <WLinksBase
        ...
        class="mb-2"
        @click.native="
          $router.push(`/portfolio/${portfolio.portfolio_number}/properties`)
        "
      >
        Back to Locations
      </WLinksBase>
...
export default {
  ...
  methods: {
    ...
    cancelProcess() {
      this.$router.push(
        `/portfolio/${this.portfolio.portfolio_number}/properties`
      )
    },
