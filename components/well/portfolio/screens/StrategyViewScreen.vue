<template>
  <div>
    <div v-if="strategy">
          ...
          @click.native="
            $router.push(
              projectType === 'portfolio'
                ? `/portfolio/${strategy.portfolio_number}/alternatives`
      ...
      >
        <PortfolioAapForm ref="aap-form" :strategy="strategy" />
      </div>
      <div
        v-if="currentScreen === 'ep-form'"
        class="shadow-lg border rounded-lg p-5"
      >
        <PortfolioEpForm ref="ep-form" :strategy="strategy" />
      </div>
        ...
        <div class="bg-white shadow-lg overflow-hidden sm:rounded-lg">
                ...
                <h3 class="text-2xl font-bold text-primary-700 uppercase my-3">
                  ...
                  >
                    <span
                      ...
                      >{{ strategy.type + '-0' + strategy.id }}</span
                    >

                    <span
                      :class="
                        type === 'WELL Health-safety'
                          ? 'md:justify-center md:ml-2 w-36'
                          : 'justify-start justify-center ml-2 w-auto'
                      "
                      class="
                        flex
                        text-center
          ...
          <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
            <dl
              class="
                grid
                md:grid-cols-4 md:gap-x-4 md:gap-y-8
                gap-y-4
                sm:grid-cols-4
              "
            >
              ...
              <div class="sm:col-span-1">
                <dt class="text-sm font-medium text-gray-500">Feature:</dt>
                <dd class="mt-1 text-sm text-gray-900">
                  <div>
                    {{
                      strategy.parts.find(
                        (part) => part.feature_id === strategy.feature_id
                      ).part_prefix
                    }}
                    -
                    {{
              ...
              <div class="sm:col-span-1">
                <dt class="text-sm font-medium text-gray-500 mt-4">Parts:</dt>
                <dd class="mt-1 text-sm text-gray-900 flex justify-center">
                  <div
                    v-if="strategy.parts.length"
                    class="space-y-1 w-48 md:w-full flex flex-wrap"
                  >
                    <div
