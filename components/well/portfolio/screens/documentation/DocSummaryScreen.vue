        ...
        >
          ...
          <tbody class="bg-white">
            <tr
              ...
              class="align-top"
            >
              <td class="p-4 font-medium border-b-2">
                <span
                  class="
                    bg-primary-600
                    text-white
              ...
              >
                <WLinksBase
                  class="text-center cursor-pointer ml-10"
                  @click.native="
                    () => {
                      $refs.summarySlide.toggleOpen()
                      activeProject = document
                    }
                  "
                >
                  <WIconsBase icon="pencil-alt" />
                </WLinksBase>
              </td>
            </tr>
          </tbody>
