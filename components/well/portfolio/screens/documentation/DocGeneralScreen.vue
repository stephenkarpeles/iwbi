<template>
  <div>
    ...
    <div
      v-if="documentsList.data && documentsList.data.length > 0"
      class="
        shadow
        overflow-hidden
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  >
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <span class="font-medium text-primary-700">{{
                          document.documentable_sub_type
                        }}</span>
                      </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="py-4 px-6 whitespace-nowrap w-1">
                      <div class="flex items-center">
                        <div
                          v-if="
...
export default {
  ...
  methods: {
    ...
    deleteScorecardDocument() {
      this.$store
        .dispatch('portfolio/deleteDocument', {
          id: this.selectedDocument.id,
          page: this.selectedDocument.current_page,
        })
        .then(() => {
