  ...
  <div class="space-y-6">
    ...
    <div class="flex">
      ...
      >
        ...
        <div class="px-6 pb-3 flex flex-col">
          ...
          <div class="text-primary-900 opacity-50">
            with individual location profiles and scorecards within your WELL
            Portfolio
          </div>
      ...
      >
        ...
        <div class="px-6 pb-3 flex flex-col">
          ...
          />
          <div class="text-primary-900 opacity-50">
            by uploading locations and fields that you want to update using WELL
            Project Numbers
          </div>

          <div
            class="mt-2"
            @click="$store.dispatch('portfolio/exportProjects')"
          >
            <label
              class="
                text-md
    ...
    <div
      class="
        ...
        px-6
        py-2
        border-2 border-primary-300 border-dashed
        rounded-md
        bg-primary-100
      "
    >
