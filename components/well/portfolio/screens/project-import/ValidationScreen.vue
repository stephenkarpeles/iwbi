      ...
      <div v-else class="flex justify-around items-center">
        <div class="w-1/2">
          ...
          >
            ...
            locations to your Portfolio and can be managed from there. You can
            preview the information in the table below to check how your
            locations would appear in WELL Online once imported.
          </span>
          <span v-else>
            ...
            Portfolio. You can preview the information in the table below to
            check how your locations would appear in WELL Online once imported.
          </span>
        </div>
        <div class="">
