    ...
    <div v-if="ticketInfo" class="xl:max-w-5xl xl:grid xl:grid-cols-3 mt-4">
        ...
        <div>
          ...
          <aside class="mt-8 xl:hidden">
            <div class="space-y-3">
              ...
              <div class="flex items-center space-x-2">
                ...
                <span class="text-gray-900 text-sm font-medium"
                  >Created on
                  {{
                    $dayjs(ticketInfo.created_at).format('MMM DD, YYYY')
                  }}</span
                >
              </div>
              <div
            ...
            <div class="mt-6 border-t border-b border-gray-200 py-6 space-y-3">
              ...
              <div v-if="ticketInfo.attachments.length > 0">
                <h2 class="text-sm font-medium text-gray-500">Attachments</h2>
                <div class="text-sm font-medium text-gray-900">
          ...
          <div>
            <div class="divide-y divide-gray-200">
              ...
              <div class="pt-6">
                <div class="flow-root">
                  <ul
                    v-if="ticketInfo.comments.length"
                    role="list"
                    class="-mb-8"
                  >
                    <li
                      ...
                      <div class="relative pb-8">
                        ...
                        <div class="relative flex items-start space-x-3">
                          ...
                          <div class="min-w-0 flex-1">
                            ...
                            <div
                              v-if="ticket_comment.attachments.length > 0"
                              class="mt-2 text-sm"
                            >
                              <p>Attachments:</p>
                              <ul class="list-disc pl-5">
      ...
      <aside class="hidden xl:block xl:pl-8">
        ...
        <div class="mt-6 border-t border-b border-gray-200 py-6 space-y-3">
          ...
          <div v-if="ticketInfo.attachments.length > 0" class="pb-4 space-y-1">
            <h2 class="text-sm font-medium text-gray-500">Attachments</h2>
            <div class="text-sm font-medium text-gray-900">
              <ul class="list-disc pl-5">
                <li
...
export default {
  ...
  methods: {
    ...
    async reopenTicket() {
      ...
      await this.$store.dispatch('support/getPortfolioTickets')
