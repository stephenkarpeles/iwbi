<template>
  <div>
    ...
    >
      ...
      <div class="py-6 space-y-4 border-b-2 border-gray-300">
        <div class="text-primary-800 flex flex-col">
          <span class="text-xl font-bold">Edit locations</span>
          <span class="pt-1"
      ...
      <div class="py-6 space-y-4">
        <div class="text-primary-800 flex flex-col">
          <span class="text-xl font-bold">Edit note</span>
          <span class="text-sm pt-2 text-primary-800 font-normal"
