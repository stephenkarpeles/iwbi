<template>
  <FormulateForm v-if="formData" @submit="updateProject">
    <div class="shadow-lg border rounded-lg p-5 mb-5">
      ...
      <FormulateInput
        v-model="formData.v1_version"
        type="select"
        label="Applicable standard version"
        name="application_v1_version"
        :options="v1VersionList"
      />
      <FormulateInput
      ...
      <div class="bg-white overflow-hidden sm:rounded-lg sm:shadow mb-4">
        ...
        <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
          ...
          <FormulateInput
            ...
            type="select"
            label="Project certification type"
            name="cert_type"
            :options="[
              { value: 'na', label: 'N/A' },
      ...
      <FormulateInput
        ...
        type="select"
        label="WELL coaching support (over project life)"
      ...
      <FormulateInput
        ...
        type="textarea"
        label="Project challenges notes"
        name="challenge_note"
        class="w-full"
      />
      <FormulateInput
      ...
      <FormulateInput
        ...
        type="textarea"
        label="WELL billing notes"
        name="billing_note"
        class="w-full"
      />
      <FormulateInput
        v-if="currentUser.role.includes('admin')"
        v-model="formData.hide_fee_schedule"
        type="radio"
        label="Hide fee structure"
        name="hide_fee_structure"
        :options="[
          { value: 'Yes', label: 'Yes' },
          { value: 'No', label: 'No' },
        ]"
      ...
      <FormulateInput
        ...
        name="test_project"
      />
      <FormulateInput class="mt-2" type="submit" label="Save Changes" />
    </div>
  </FormulateForm>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      v1VersionList: [
        { value: 'q4-2020', label: 'Q4 2020 version' },
        { value: 'q3-2020', label: 'Q3 2020 version' },
        { value: 'q2-2020', label: 'Q2 2020 version' },
        { value: 'q1-2020', label: 'Q1 2020 version' },
        { value: 'q4-2019', label: 'Q4 2019 version' },
        { value: 'q3-2019', label: 'Q3 2019 version' },
        { value: 'q2-2019', label: 'Q2 2019 version' },
        { value: 'q1-2019', label: 'Q1 2019 version' },
        { value: 'q4-2018', label: 'Q4 2018 version' },
        { value: 'q3-2018', label: 'Q3 2018 version' },
        { value: 'q2-2018', label: 'Q2 2018 version' },
        { value: 'q1-2018', label: 'Q1 2018 version' },
        { value: 'q4-2017', label: 'Q4 2017 version' },
        { value: 'q3-2017', label: 'Q3 2017 version' },
        { value: 'q2-2017', label: 'Q2 2017 version' },
        { value: 'jan-2017', label: 'January 2017 version' },
        { value: 'oct-2016', label: 'October 2016 version' },
        { value: 'may-2016', label: 'May 2016 version' },
        { value: 'feb-2016', label: 'February 2016 version' },
        { value: 'sep-2015', label: 'September 2015 version' },
        { value: 'feb-2015', label: 'February 2015 version' },
      ],
