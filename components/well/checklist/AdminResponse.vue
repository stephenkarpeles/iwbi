...
export default {
  ...
  computed: {
    ...mapState('checklist', ['adminReviewResponses']),
      ...
      if (this.pendingReview) {
        if (this.pendingReview.phase.includes('Precertification')) {
          return [
            ...
            {
              label:
                'Intent-stage documentation has not been provided indicating that the part requirements will be met. To demonstrate compliance, the following must be addressed.COMMENTS TO BE ADDRESSED',
              value:
                'Intent-stage documentation has not been provided indicating that the part requirements will be met. To demonstrate compliance, the following must be addressed.<br/>COMMENTS TO BE ADDRESSED<ol><li></li></ol>',
            },
            {
              label:
                'Implementation-stage documentation has been provided. However, to demonstrate compliance, the following must be addressed.COMMENTS TO BE ADDRESSED',
              value:
                'Implementation-stage documentation has been provided. However, to demonstrate compliance, the following must be addressed.<br/>COMMENTS TO BE ADDRESSED<ol><li></li></ol>',
            },
            {
              label:
                'Intent-stage documentation has been provided. However, to demonstrate compliance, the following must be addressed.COMMENTS TO BE ADDRESSED',
              value:
                'Intent-stage documentation has been provided. However, to demonstrate compliance, the following must be addressed.<br/>COMMENTS TO BE ADDRESSED<ol><li></li></ol>',
            },
          ]
        } else {
          return [
            {
              label: 'This part has no required documentation.',
              value: 'This part has no required documentation.',
            },
            {
              label:
            ...
            {
              label: 'This Feature has been withdrawn.',
              value: 'This Feature has been withdrawn.',
            },
            {
              label: 'This Feature has not been attempted.',
              value: 'This Feature has not been attempted.',
            },
            {
              label:
                'Documentation has been provided. However, to demonstrate compliance, the following must be addressed.COMMENTS TO BE ADDRESSED',
              value:
                'Documentation has been provided. However, to demonstrate compliance, the following must be addressed.<br/>COMMENTS TO BE ADDRESSED<ol><li></li></ol>',
            },
          ]
        }
      } else {
