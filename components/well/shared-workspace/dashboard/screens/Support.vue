<template>
  <div data-page="support">
    <NavBreadcrumbs>
      <WHeadingsHTwo
        heading="Support"
        sub-heading="Below, you'll find the articles, webcasts and tools to help you earn the WELL Health-Safety Seal. Listen to webcasts featuring industry leaders prioritizing health and safety, get tips and tricks to guide your progress and dig into your WELL Health-Safety toolkit.
"
      />
    </NavBreadcrumbs>
    <div
...
export default {
  ...
  computed: {
    ...
    checkAssetLocations() {
      // Check if the number of asset locations is greater than 1
      if (this.sharedworkspace?.no_of_assets > 1) {
        return true
      }
      return false
    },
    resources() {
        ...
        list = [
          {
            ...
            options: [
              {
                title: 'WELL Health-Safety Rating Tutorial Series',
                image:
              ...
              {
                title: 'Overview: the WELL Health-Safety Rating Process',
                image:
                  'https://a.storyblok.com/f/52232/856x524/0dbb6d2ca7/process-thumb.png',
                target: '_blank',
                path: 'http://resources.wellcertified.com/articles/overview-the-well-health-safety-rating-process',
              },
              {
                title:
                  'Deep Dive: Exploring the WELL Health-Safety Rating Features',
                image:
              ...
              {
                title: 'How to Create and Upload WELL Documentation',
                image:
              ...
              {
                title: 'The WELL Health-Safety Rating Review Process',
                image:
              ...
              {
                title: 'How to Promote your WELL Health-Safety Rating',
                image:
                  'https://a.storyblok.com/f/52232/856x524/0e9c97467a/promotion-thumb.png',
                target: '_blank',
                path: 'http://resources.wellcertified.com/articles/how-to-promote-your-well-health-safety-rating',
              },
            ],
          },
          {
            ...
            options: [
              {
                ...
                image:
                  'https://cdn.wellcertified.com/static/images/rating-guidebook.png',
                target: '_blank',
              ...
              {
                title: 'Letter of Assurance Template',
                image:
              ...
              {
                title:
                  'Interiors + Base Buildings: Applying WELL Certification in a WELL Certified Base Building',
                image:
              ...
              {
                title: 'WELL Health-Safety Rating Documentation 101',
                image:
                  'https://a.storyblok.com/f/52232/856x524/7e42333951/documentation-thumb.png',
                target: '_blank',
              ...
              {
                title: 'Multiple Locations Document Sharing Form',
                image: 'projects/v2/promotions/support-card.jpg',
                target: '_blank',
        ...
        list = [
          {
            ...
            options: [
              {
                title:
                  'Overview: the WELL Health-Safety Rating renewal process',
                image:
                  'https://a.storyblok.com/f/52232/856x524/0dbb6d2ca7/process-thumb.png',
                target: '_blank',
      ...
      if (this.assetLocations <= 1) {
        const cloneArray = [...list]
        cloneArray[1].options.pop()
        list = cloneArray
      }
      return list
    },
  ...
  mounted() {
    if (this.sharedWorkspace) {
      this.assetLocations = this.sharedWorkspace.no_of_assets
    }
