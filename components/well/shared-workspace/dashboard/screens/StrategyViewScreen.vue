  ...
  <div>
    <div v-if="strategy">
      <div class="flex justify-between">
        <WLinksBase
          v-if="currentScreen === 'landing' && $route.params.id"
          link="#"
          icon="arrow-narrow-left"
          @click.native="
            $router.push(
              projectType
                ? `/${projectType}/${strategy.portfolio_number}/alternatives`
                : `/shared-workspaces/${strategy.portfolio_number}/alternatives`
            )
          "
        >
        ...
        <WLinksBase
          ...
          @click.native="
            ...
            currentUser.role.includes(`well-assessor`)
              ? $router.push(`/well-admin/alternatives`)
      ...
      >
        <SharedAapForm ref="aap-form" :strategy="strategy" />
      </div>
      <div
        v-if="currentScreen === 'ep-form'"
        class="shadow-lg border rounded-lg p-5"
      >
        <SharedEpForm ref="ep-form" :strategy="strategy" />
      </div>
      <div v-if="currentScreen === 'landing'">
        <div class="bg-white shadow-lg overflow-hidden sm:rounded-lg">
          <div class="md:px-4 px-2 py-5 sm:px-6">
            <div class="grid md:grid-cols-4 gap-x-4 gap-y-8">
          ...
          <div class="border-t border-gray-200 md:px-4 px-2 py-5 sm:px-6">
            <dl
              ...
              <div class="sm:col-span-3">
                ...
                <dd class="mt-1 text-sm text-gray-900">
                  <WLinksBase
                    :link="
                      projectType
                        ? `/${projectType}/${strategy.portfolio_number}/dashboard`
                        : `/shared-workspaces/${strategy.portfolio_number}/dashboard`
                    "
                    target="_blank"
                  >
              ...
              <div class="sm:col-span-1">
                ...
                <dd class="mt-1 text-sm text-gray-900">
                  <div v-if="strategy.parts.length">
                    <div v-for="prt in strategy.parts" :key="prt.id">
                      {{ prt.part_prefix + ' ' + prt.name }}
                      <br />
                      {{ prt.feature_name }}
                    </div>
                  </div>
                  <div v-if="strategy.type_internal === 'v1'">
                    {{ strategy.v1feature.name }}
                    <span
                      class="text-center w-32 p-1 bg-primary-500 text-white rounded-full px-2 text-xs font-semibold mb-4"
              ...
              <article aria-labelledby="question-title-81614">
                ...
                <div class="mt-2 text-sm text-gray-700 space-y-4">
                  ...
                  <dl
                    ...
                    class="md:grid md:grid-cols-4 gap-x-4 gap-y-8 sm:grid-cols-4"
                  >
                    <div class="sm:col-span-3">
                      <dd class="mt-1 text-sm text-gray-900">
                        <ul
