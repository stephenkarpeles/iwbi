  ...
  <div>
    ...
    <div v-if="review">
      ...
      <WFeedbackModal ref="deleteModal">
        ...
        <div
          class="mt-8 sm:mt-4 sm:flex sm:flex-row-reverse space-y-3 md:space-y-0 justify-between"
        >
          <div>
            <WButtonsBase
              type="danger"
          ...
          <div>
            <div class="lg:border-b lg:pb-6">
              ...
              >
                ...
                <!-- Return Review button start here -->
                <div
                  v-if="
                ...
                <!-- Re-Submit Review button start here -->
                      ...
                      <div class="w-64 p-2 space-y-2">
                        ...
                        <WButtonsBase
                          v-if="
                            review.phase.includes(
                              'Final Health-Safety Review'
                            ) ||
                            review.phase.includes(
                              'Curative Action Plan Review'
                            ) ||
                            review.phase.includes(
                        ...
                        <WButtonsBase
                          v-if="
                            ...
                            review.phase.includes('Curative Action Plan Review')
                          "
                          type="subNav"
                          class="bg-white text-black"
                          @click.native="
