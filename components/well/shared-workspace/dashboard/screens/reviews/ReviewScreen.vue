    ...
    <div v-if="showreviewdetails">
      ...
      >
        <p class="text-sm text-primary-700">
          A hallmark of the WELL Health-Safety Rating is a third-party review
          ...
          health intent of each strategy has been successfully achieved at each
          location. GBCI is the organization IWBI partners with to provide these
          reviews. Most review cycles have two rounds, a preliminary review and
          a final review. This enables teams to respond to comments, clarify
          issues or supply any missing information.
          <span v-if="recertificationList.length > 0">
            For WELL Health-Safety renewal submissions, each round of review
            will take GBCI 8-10 business days to complete.
          </span>
          <span v-else>
            For single location WELL Health-Safety submissions, each round of
            review will take GBCI 8-10 business days to complete. For multiple
            location WELL Health-Safety submissions, depending on the complexity
            and quality of the review submission, review timelines may be longer
            than the standard of 8-10 business days, with a maximum of up to 25
            business days.
          </span>
        </p>
      </div>
      ...
      >
        ...
        <p class="mg-b-5 text-sm text-primary-700">
          ...
          GBCI to commence a review:
        </p>
        <ul class="list-disc ml-5 md:ml-8 mb-5 text-sm text-primary-700">
          <li>
            A completed checklist with a minimum of 15 features marked as YES to
            ...
            <ul class="list-disc ml-5 md:ml-8 mb-5 text-sm text-primary-700">
              <li>
                ...
                <a
                  ...
                  target="_blank"
                  >WELL Health-Safety Guidebook</a
                >.
              </li>
              <li>
