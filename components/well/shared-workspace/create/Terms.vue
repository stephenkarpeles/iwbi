                    ...
                    >
                      ...
                      <!-- <p>
                        ...
                        <b
                          ...
                          or the WELL Health-Safety Rating will be prompted upon
                          issuance of award, if any, to transition to public
                          status. A project that wishes to remain a private
                          project will need to re-confirm its private status at
                          the time of certification/rating.</b
                        >
                      </p>
...
export default {
  ...
  methods: {
    ...
    async updateSharedWorkspace() {
      ...
      await this.sendviaEmail(this.$store.state.shared.sharedWorkspace.id)
