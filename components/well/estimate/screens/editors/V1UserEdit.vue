<template>
  <div v-if="formData">
    ...
    >
      <WHeadingsHTwo class="pb-5" heading="WELL Community Pricing Calculator" />
      <div class="shadow-md flex flex-wrap justify-between border rounded-md">
        ...
        >
          <div class="grid grid-cols-2 gap-x-4 gap-y-4 w-full">
            ...
            />
            <FormulateInput
              v-model="formData.estimate.company"
      ...
      >
        ...
        <div
          class="flex flex-wrap px-8 py-4 w-full justify-between text-gray-400"
        >
          <div class="flex space-x-4 gap-y-4 w-full">
            <FormulateInput
      ...
      <div>
        <FormulateErrors
          class="my-2 text-danger-400 shadow-lg p-2 rounded bg-red-100 text-center"
        />
      </div>
  ...
  methods: {
    ...
    async submitEstimate() {
      ...
      const data = {
        ...
        organization: this.formData.estimate.company.name,
        company_id: this.formData.estimate.company.id,
