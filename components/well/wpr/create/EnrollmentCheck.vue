  ...
  <div>
    <div v-if="sharedWorkspace" class="px-4 md:px-8 py-6">
      ...
      <p class="-mt-2">
        ...
        details of the
        <a
          href="https://www.wellcertified.com/performance/"
          target="_blank"
          class="text-primary-600"
          >WELL Performance Rating</a
        ...
        <WLinksBase link="/wpr" class="inline-flex"
          >WELL Performance Rating project list.</WLinksBase
        >
      </p>
      <WPRProjectList />
      ...
      <div
        class="md:flex justify-center mt-10 space-y-2 md:space-y-0 gap-x-2 gap-y-2"
      >
        <div class="md:w-44">
          <WButtonsBase
