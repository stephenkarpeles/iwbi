              ...
              <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                <div class="px-6 pt-8 pb-1 md:pb-8 bg-white sm:p-10 sm:pt-6">
                  <div>
                    <h3
                      id="tier-standard"
                      class="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase bg-primary-200 text-primary-800"
                    >
                      TYPE ONE
                    </h3>
                  </div>
                  <div
                    class="mt-4 flex items-baseline text-xl xl:text-3xl leading-none font-extrabold"
                  >
                    Standard Locations
                  </div>
                ...
                <div
                  class="flex-1 flex flex-col justify-end px-6 pt-0 md:pt-6 pb-6 md:pb-8 bg-white space-y-6 sm:p-10 sm:pt-6"
                >
