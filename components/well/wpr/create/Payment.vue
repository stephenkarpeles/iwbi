  ...
  methods: {
            ...
            if (result.error) {
              ...
              this.$axios
                ...
                .then((response) => {
                  ...
                  } else if (self.redirectPath) {
                    this.$router.push(self.redirectPath)
                  } else {
                    this.$router.push(
                      `/wpr/${this.sharedWorkspace.portfolio_number}/dashboard`
                    )
                  }
                })
                .catch((error) => {
    ...
    async setUserPreference() {
      try {
        ...
        const message = errors.organization
          ? 'Organization is required to download invoice'
