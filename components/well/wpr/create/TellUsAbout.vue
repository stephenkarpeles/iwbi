            ...
            <div class="mx-auto lg:mx-0">
              <ClientOnly>
                <div class="md:flex">
                  ...
                  >
                    ...
                    Performance Rating at a reduced fee.
                  </div>
                </div>
              </ClientOnly>
              <div class="md:flex">
                <FormulateInput
                  ...
                  type="text"
                  name="organization"
                  label="What shall we call this WELL Performance Rating enrollment?*"
                  class="mr-5 md:w-1/2"
                  validation="required"
                />
                <FormulateInput
              ...
              <div class="flex">
                <div class="md:w-1/2 mr-5">
                  ...
                  <FormulateInput
                    v-if="formData.industry !== null"
                    v-model="formData.sub_sector"
                    type="select"
                    :options="subSectors"
                    label="Organization Subsector/Industry*"
                    class="mr-5 w-full"
                    validation="required"
                  />
      ...
      <div class="hidden lg:block lg:absolute lg:inset-0">
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            src="/wpr/enrollment/enrollment-2.png"
            alt=""
          />
        </div>
      </div>
...
export default {
      ...
      orgSectorList: [
        ...
        },
        {
          ...
          subSectors: [
            ...
            {
              value:
                'Transportation Hub (Train Station/Bus Station/Ground travel)',
              label:
                'Transportation Hub (Train Station/Bus Station/Ground travel)',
            },
          ],
        },
        {
          ...
          subSectors: [
            ...
            { value: 'Primary or Secondary', label: 'Primary or Secondary' },
        ...
        },
        {
          ...
          subSectors: [
            ...
            { value: 'Retail', label: 'Retail' },
            { value: 'Sports Venue', label: 'Sports Venue' },
        ...
        },
        {
          ...
          subSectors: [
            ...
            { value: 'Inpatient Facility', label: 'Inpatient Facility' },
            { value: 'Medical Office', label: 'Medical Office' },
            { value: 'Outpatient Facility', label: 'Outpatient Facility' },
          ],
        },
        {
          value: 'Office',
          ...
          subSectors: [
            { value: 'Architecture', label: 'Architecture' },
            {
              value: 'Biotechnology/Chemicals',
              label: 'Biotechnology/Chemicals',
            },
  ...
  created() {
    if (this.$route.params.id) {
      this.formData = {
        ...
        sub_sector: this.sharedWorkspace.sub_sector,
      ...
      if (address && billingAddress) {
        if (
          address.country_code === billingAddress.country_code &&
          address.street === billingAddress.street &&
          address.city === billingAddress.city &&
          address.postal_code === billingAddress.postal_code &&
  ...
  methods: {
    async createSharedWorkspace() {
      if (this.currentStep === 0 && this.formData.reg) {
        ...
        const sharedWorkspace = {
          ...
          sub_sector: this.formData.sub_sector,
        ...
        if (!this.$route.params.id) {
          ...
          this.$router.push(
            `/wpr/create/${this.$store.state.shared.sharedWorkspace.portfolio_number}`
          )
        } else {
          await this.$store.dispatch(
    ...
    setSubSectors() {
      const result = this.orgSectorList.find((obj) => {
        return obj.value === this.formData.industry
      })
      if (this.formData.industry !== null) {
        this.subSectors = result.subSectors
      }
    },
  },
}
