      ...
      >
        <div class="py-2 align-middle inline-block w-full sm:px-6 lg:px-8">
          <NavBreadcrumbs>
            ...
            <template #actions>
              <div class="md:flex gap-x-2 gap-y-2 md:grid justify-end">
          ...
          <form
            ...
            "
          >
            <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-5">
              <FormulateInput
                v-model="filters.portfolio_number"
                type="text"
                placeholder="ID"
                label="Performance Rating ID"
              />
              <FormulateInput
            ...
            <div class="md:flex gap-x-2 gap-y-2 w-full">
              <FormulateInput
                type="submit"
                label="Apply"
                class="my-auto pt-1 md:w-44"
              />
              <div class="my-auto pt-1 md:w-44">
                <WButtonsBase
                  v-if="
  ...
  methods: {
    ...
    goToNextStep(sharedWorkspace) {
      if (sharedWorkspace.portfolio_status === 'Expired') {
        ...
        this.$router.push(`/wpr/${sharedWorkspace.portfolio_number}/documents`)
      } else if (this.paidStatus(sharedWorkspace)) {
        this.$router.push(`/wpr/${sharedWorkspace.portfolio_number}/dashboard`)
      } else {
        this.$router.push(
