        ...
        <div :class="{ hidden: currentTab !== 'HSR' }">
          <FormulateForm class="space-y-2">
            <div class="rounded-lg md:p-5 py-5">
              <WHeadingsHFour
                heading="WELL Performance Rating Story"
                class="border py-3 w-full px-3 -mt-5"
              />

              <WCardsBase>
                <p class="pb-1 text-sm font-semibold text-gray-700">
                  Why did your project decide to pursue WELL Performance Rating?
                ...
                <p class="pb-1 mt-4 text-sm font-semibold text-gray-700">
                  How did your team approach the WELL Performance Rating
                ...
                <p class="pb-1 mt-4 text-sm font-semibold text-gray-700">
                  ...
                  Performance Rating features? How did you solve them?
                </p>
                <ClientOnly>
                  <FormulateInput
                    v-model="challenges"
                ...
                <p class="pb-1 mt-4 text-sm font-semibold text-gray-700">
                  What positive impacts resulted from your WELL Performance
                  Rating?
                </p>
                <ClientOnly>
                  <FormulateInput
                ...
                <p class="pb-1 mt-4 text-sm font-semibold text-gray-700">
                  How has WELL Performance Rating changed or improved your
