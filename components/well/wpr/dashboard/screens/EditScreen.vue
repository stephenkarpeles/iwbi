          ...
          <div class="shadow-lg border rounded-lg p-5">
            ...
            <div class="mb-5">
              <FormulateInput
                ...
                name="projectName"
                label="Project Name"
                :disabled="!currentUser.role.includes('well-admin')"
              />
            </div>
            ...
            <div class="mb-5">
              <FormulateInput
                ...
                label="WELL Performance Rating scope & premises"
                type="textarea"
              />
            </div>
            <div class="mb-5">
              <FormulateInput
                ...
                label="WELL Performance Rating goals and vision"
                type="textarea"
              />
            </div>
            <div class="shadow-md justify-between border rounded-md mt-5 mb-5">
              ...
              <div class="px-8 py-4">
                <div>
                  <p class="text-sm">
                    ...
                    Performance Rating or use any IWBI intellectual location
          ...
          <div class="shadow-lg border rounded-lg p-5">
            ...
            <div class="shadow-md justify-between border rounded-md mt-5 mb-5">
              <div
                class="w-full bg-primary-50 rounded-t-md border-b px-8 py-4 text-primary-800"
              >
                <div class="font-bold">WELL Performance Rating</div>
              </div>
              <div class="px-8 py-4">
                <div class="mb-5">
                  <FormulateInput
...
export default {
    ...
    return {
      ...
      portfolioPhaseInternal: [
        ...
        { value: 'Certification Decision', label: 'Certification Decision' },
        {
          ...
          label: 'Preliminary Performance Rating Review',
        },
        {
          value: 'Final Health-Safety Review',
          label: 'Final Performance Rating Review',
        },
        {
          value: 'Final Health-Safety Application',
          label: 'Final Performance Rating Application',
        },
        {
          value: 'Final Health-Safety Rating Achieved',
          label: 'Final Performance Rating Rating Achieved',
        },
        {
          value: 'Final Health-Safety Rating Appeal',
          label: 'Final Performance Rating Rating Appeal',
        },
      ],
      docSubmitPhase: '',
      portfolioCertStatus: [
  ...
  methods: {
    ...
    saveProject() {
      ...
      this.$router.push(`/wpr/${this.formData.portfolio_number}/dashboard`)
    },
