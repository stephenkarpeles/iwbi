<template>
  <div>
    <div v-if="sharedWorkspace">
      ...
      >
        <LazyNavWorkspaceSidebarSearch module-type="wpr" />
      </div>
        ...
        <template #buttons>
          <div class="mb-2">
            ...
            <!-- <WButtonsBase
              ...
              @click.native="
                $router.push(
                  `/wpr/${sharedWorkspace.portfolio_number}/scorecard`
                ),
                  toggleExpand()
              "
            >
            ...
            <WButtonsBase
              ...
              @click.native="
                $router.push(
                  `/wpr/${sharedWorkspace.portfolio_number}/reviews`
                ),
                  toggleExpand()
              "
            >
        ...
        <template #buttons>
          <div class="mb-2">
            <WButtonsBase
              ...
              @click.native="
                $router.push(
                  `/wpr/${sharedWorkspace.portfolio_number}/profile`
                ),
                  toggleExpand()
              "
            >
        ...
        <template #buttons>
          <div class="mb-2">
            <WButtonsBase
              ...
              icon="user-groups"
              @click.native="
                $router.push(`/wpr/${sharedWorkspace.portfolio_number}/team`),
                  toggleExpand()
              "
            >
            ...
            <WButtonsBase
              ...
              @click.native="
                $router.push(
                  `/wpr/${sharedWorkspace.portfolio_number}/support`
                ),
                  toggleExpand()
              "
            >
            ...
            <WButtonsBase
              ...
              @click.native="
                $router.push(
                  `/wpr/${sharedWorkspace.portfolio_number}/alternatives`
                ),
                  toggleExpand()
              "
            >
            ...
            <WButtonsBase
              ...
              @click.native="
                $router.push(
                  `/wpr/${sharedWorkspace.portfolio_number}/locations`
                ),
                  toggleExpand()
              "
            >
            ...
            <WButtonsBase
              ...
              icon="pencil-alt"
              @click.native="
                $router.push(`/wpr/${sharedWorkspace.portfolio_number}/edit`),
                  toggleExpand()
              "
            >
